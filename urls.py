...
urlpatterns = patterns(
    ...
    url(r'^signup/$', 'userena.views.signup', name='userena_signup'),
    url(r'^signin/$', 'userena.views.signin', name='userena_signin'),
    url(
        r'^signout/$',
    ...
    url(r'^beta/$', 'hunger.views.invite', name='beta_invite'),
    url(r'^beta/sent', 'hunger.views.confirmation', name='beta_confirmation'),
    url(
        r'^beta/verify/(\w+)/$',
        'hunger.views.verify_invite',
        name='beta_verify',
    ),
    url(r'^beta/expired', 'hunger.views.expired', name='beta_used'),
    url(
        r'^password/reset/$',
    ...
    url(
        r'^(?P<username>[^/]+)/create_team/$',
        'teams.views.create_team',
        name='create_team',
    ),
    url(
        r'^(?P<username>[^/]+)/members/$',
        'teams.views.update_team',
        name='update_team',
    ),
    (
        f'(?P<url>{flatpage_pattern}/)',
